...
if (isset($_POST['tambah_maintenance'])) {
    ...
    $jumlah = (int)$_POST['jumlah']; // <-- TAMBAHAN: Ambil jumlah
    ...
    try {
        // Insert ke maintenance_log dengan jumlah
        ...
        // Update status produk (stok sudah otomatis berkurang saat disewa, jadi cukup ubah status)
...
if (isset($_GET['hapus'])) {
    ...
    if ($log) {
        // Jika masih dalam perbaikan, kembalikan status DAN stoknya
...
$where_clause = "WHERE ml.status != 'selesai'"; // Default: tampilkan yang aktif saja
if ($filter_status != '') {
...
<head>
    ...
    <title>Kelola Maintenance - SIMRO</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h4 class="fw-bold mb-0 text-dark">
                <i class="fas fa-screwdriver-wrench me-2 text-maroon"></i>Kelola Maintenance
            </h4>
    ...
    <!-- MODAL TAMBAH MAINTENANCE MANUAL -->
